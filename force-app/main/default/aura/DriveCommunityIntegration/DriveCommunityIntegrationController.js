({
    ...
    //Authorize
    authorizationDrive : function(component, event, helper) {       
        var action = component.get('c.driveAuth');	
        action.setParams({
    ...
    deleteHandler : function(component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            {               
                var jsonString = response.getReturnValue();
                helper.afterdelete(component,id);                   
            }
        });
        $A.enqueueAction(action);        
    },
